...
void display ()
{
    ...
    glPopMatrix        ();
                                            // make 1st pass - diffuse intensity
    ...
    glEnd   ();
                                            ...
                                            // make 2nd pass - modulate by decal
    glActiveTextureARB ( GL_TEXTURE0_ARB );
...
int main ( int argc, char * argv [] )
{
    ...
    glutInitWindowSize  ( 500, 500 );
                                ...
                                // create window
    int win = glutCreateWindow ( "OpenGL texture_env_dot3 example 2" );
...
//	bumpMap     = createNormalMapFromHeightMap ( true, "../Textures/Bumpmaps/FieldStoneBump.bmp", 4.0 );
