...
int main ( int argc, char * argv [] )
{
	...
	glutInitWindowSize  ( 500, 500 );
								...
								// create window
	glutCreateWindow ( "OpenGL per-pixel specular lit torus via fragment & vertex programs" );
	...
	bumpMap     = createNormalMapFromHeightMap ( false, "../Textures/Bumpmaps/oxidatedBump.png", 12 );
	ambMap      = createTexture2D              ( true,  "../Textures/emission.jpg" );
