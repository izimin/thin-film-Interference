...
int main ( int argc, char * argv [] )
{
	...
	bumpMap     = createNormalMapFromHeightMap ( false, "../Textures/Bumpmaps/limestoneBump.png", 3 );
	decalMap    = createTexture2D              ( true,  "../Textures/limestone.dds" );
	...
	if ( !fragmentProgram.load ( "specular.fp" ) )
	{
