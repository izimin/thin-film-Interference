//
// Sample to per-pixel chrome lighting with fragemnt programs in OpenGL
//
...
int main ( int argc, char * argv [] )
{
	...
	glutInitWindowSize  ( 500, 500 );
								...
								// create window
	glutCreateWindow ( "OpenGL per-pixel chrome lit torus via fragment & vertex programs" );
	...
	bumpMap     = createNormalMapFromHeightMap ( false, "../Textures/Bumpmaps/light03.tga", 2 );
	decalMap    = createTexture2D              ( true,  "../Textures/Oxidated.jpg" );

	if ( !vertexProgram.load ( "chrome.vp" ) )
	{
	...
	if ( !fragmentProgram.load ( "chrome.fp" ) )
	{
