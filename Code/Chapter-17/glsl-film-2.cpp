...
void display ()
{
    ...
    glBindTexture      ( GL_TEXTURE_2D, backMap );

    glActiveTextureARB ( GL_TEXTURE2_ARB );
    glBindTexture      ( GL_TEXTURE_2D, burnMap );
...
int main ( int argc, char * argv [] )
{
    ...
    glutInitWindowSize  ( 512, 512 );
                                ...
                                // create window
    glutCreateWindow ( "OpenGL image postprocessing - \"Third Space\"effect" );
    ...
    if ( !program.loadShaders ( "film-2.vsh", "film-2.fsh" ) )
    {
    ...
    burnMap  = createTexture2D ( true, "ThirdSpace.bmp" );
//    backMap  = createTexture2D ( true, "../Textures/FieldStone.tga" );
    backMap  = createTexture2D ( true, "../Textures/limestone.dds" );

    program.bind ();
    program.setTexture ( "mainTex", 0 );
    program.setTexture ( "backTex", 1 );
    program.setTexture ( "burnTex", 2 );
    program.unbind ();
