...
int main ( int argc, char * argv [] )
{
	...
	glutInitWindowSize  ( 500, 500 );
								...
								// create window
	glutCreateWindow ( "More complex example of GLSL specular perpixel shader" );
	...
	if ( !program.loadShaders ( "specular-2.vsh", "specular-2.fsh" ) )
	{
	...
	diffuseMap  = createTexture2D ( true, "../Textures/FieldStone.tga" );
	specularMap = createTexture2D ( true, "../Textures/floor.bmp" );
    ...
    program.setTexture ( "specularMap", 2 );
