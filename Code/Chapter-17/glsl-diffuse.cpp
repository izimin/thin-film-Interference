...
void	animate ()
{
	...
	glPushMatrix   ();
	glLoadIdentity ();
	glLightfv      ( GL_LIGHT0, GL_POSITION, Vector4D ( light, 1 ) );
	glPopMatrix    ();
...
int main ( int argc, char * argv [] )
{
	...
	glutInitWindowSize  ( 500, 500 );
								...
								// create window
	glutCreateWindow ( "Simple example of GLSL diffuse perpixel shader" );
	...
	if ( !program.loadShaders ( "diffuse.vsh", "diffuse.fsh" ) )
	{
