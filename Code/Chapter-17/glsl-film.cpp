...
int main ( int argc, char * argv [] )
{
    ...
    glutInitWindowSize  ( 512, 512 );
                                ...
                                // create window
    glutCreateWindow ( "OpenGL image postprocessing - old film effect" );
    ...
    scratchMap = createTexture2D ( true, "../Textures/Oldfilm/scratches.jpg" );
    blipMap    = createTexture2D ( true, "../Textures/Oldfilm/blips.jpg"    );
