//
// Example of GLSL thin-layer effect shader.
//
...
int main ( int argc, char * argv [] )
{
	...
	glutInitWindowSize  ( 500, 500 );
								...
								// create window
	glutCreateWindow ( "Example of GLSL thin-layer shader" );
	...
	if ( !program.loadShaders ( "ThinLayer.vsh", "ThinLayer.fsh" ) )
	{
    ...
    program.bind ();
	program.setTexture ( "diffuseMap", 0 );
