//
// Sample to to show diffuse lighting usinf Register Combiners and vertex programs support in OpenGL
//
...
int main ( int argc, char * argv [] )
{
	...
	glutInitWindowSize  ( 500, 500 );
								...
								// create window
	int	glWin = glutCreateWindow ( "Torus with  per-pixel diffuse lighting via register combiners" );
...
//	bumpMap     = createTexture2D              ( true,  "normal2.bmp" );
