...
int main ( int argc, char * argv [] )
{
	...
	glutInitWindowSize  ( 500, 500 );
							...
							// create window
	int	win = glutCreateWindow ( "OpenGL per-pixel specular lit torus with register combiners" );
	...
	bumpMap     = createNormalMapFromHeightMap ( true, "../Textures/Bumpmaps/light06.tga", 1 );
